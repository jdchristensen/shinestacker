...
### Added
- support of images in PNG format, both in 8 bit and 16 bit depth. Note that EXIF data are not supported for 16 bit PNG because of limitations in the PIL and Open CV python libraries.
