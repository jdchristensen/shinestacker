...
class _Constants:
    ...
    FIELD_SUBSAMPLE_OPTIONS_1 = [f"1/{n}" for n in FIELD_SUBSAMPLE_VALUES_1]
    ...
    DEFALUT_ALIGN_RES_TARGET_MPX = 2
    ...
    DEFALUT_BALANCE_RES_TARGET_MPX = 2
